...
#pragma omp parallel for private(ii, i) if (N > P_MIN) 
    ...
    /* Blocked loops */
#pragma omp parallel for private(ii, j, i, prime_sq, first_odd_mult, loop_end, num_index) \
                         if (N > P_MIN) \
